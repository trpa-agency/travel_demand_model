...
beach 				  the relative attractiveness of beaches in the zone.  
                                       If a zone has no beaches, this value is zero; since this is a relative attractiveness, 
						the absolute value does not matter (zone A with an attractiveness of 1 and B with an 
