 ...
 */
public class JointStopsTest {

    static Logger logger = Logger.getLogger(JointStopsTest.class);
    ...
    public static void main(String[] args) {
        ...
        ham.createBigHHArrayFromDiskObject("_afterMandatoryStops.doa");

        logger.info( "Running Stop Frequency, Location and Mode Choice for Joint Tours");
        JointStops jointStops = new JointStops(tahoeRb, ham);
        ...
        if (ResourceUtil.getBooleanProperty(tahoeRb, "write.disk.object.arrays", false)) {
            ...
            ham.writeDiskObjectArray(diskArrayFileName + "_afterJointStops.doa");
        }
