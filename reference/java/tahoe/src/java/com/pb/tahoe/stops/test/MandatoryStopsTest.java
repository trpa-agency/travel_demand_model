 ...
 */
public class MandatoryStopsTest {

    static Logger logger = Logger.getLogger(MandatoryStopsTest.class);
    ...
    public static void main(String[] args) {
        ...
        ham.createBigHHArrayFromDiskObject("_afterAtWorkDTM.doa"); 

        logger.info( "Running Stop Frequency, Location and Mode Choice for Mandatory Tours");
        MandatoryStops manStops = new MandatoryStops(tahoeRb, ham);
        ...
        if (ResourceUtil.getBooleanProperty(tahoeRb, "write.disk.object.arrays", false)) {
            ...
            ham.writeDiskObjectArray(diskArrayFileName + "_afterMandatoryStops.doa");
        }
