...
/**
 * NonMandatoryStops is a class that ...
 *
 * @author Christi Willison
 * @version 1.0,  Oct 16, 2006
 */
public class NonMandatoryStops {
    ...
    public NonMandatoryStops (ResourceBundle propertyMap, HouseholdArrayManager hhMgr) {


        this.hhMgr = hhMgr;

        stopsHH = new StopsHousehold ( propertyMap, TourType.NON_MANDATORY_CATEGORY, TourType.getTourTypesForCategory(TourType.NON_MANDATORY_CATEGORY) );
